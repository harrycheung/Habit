...
class AppDelegate: UIResponder, UIApplicationDelegate, UNUserNotificationCenterDelegate {
  ...
  func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
    ...
    attr[NSAttributedStringKey.font] = FontManager.regular(size: 15)
    ...
    if HabitApp.timeZone == "" {
      ...
      HabitApp.timeZone = TimeZone.current.identifier
...
//    UIApplication.shared.applicationIconBadgeNumber = HabitManager.overdue
  ...
  func userNotificationCenter(_ center: UNUserNotificationCenter, didReceive response: UNNotificationResponse, withCompletionHandler completionHandler: @escaping () -> Void) {
    HabitManager.handleNotification(notification: response.notification, identifier: response.actionIdentifier)
    completionHandler()
  }
